  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validate()) {
      const dataToSubmit = {
        ...
        home_team_id: Number(formData.home_team_id), // Let's make sure this is the number
        away_team_id: Number(formData.away_team_id), // Let's make sure this is the number
        stadium_id: Number(formData.stadium_id),   // Let's make sure this is the number
      };
