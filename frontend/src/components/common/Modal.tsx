...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, size = 'md' }) => {
  // Effect for blocking background scrolling when a modal window is open
  useEffect(() => {
    if (isOpen) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        // We stop the event from popping up so that a click inside the modal does not close it
...
// Let's add simple animations to your CSS file
// Please add this code to your file `frontend/src/index.css`
