...
import { User, Sun, Moon, Monitor, LogOut, Settings } from 'lucide-react'; // CHANGED: 'Menu' deleted
import { useNavigate } from 'react-router-dom';
import { useTheme } from '@/context/ThemeContext';
import { useAuth } from '@/context/AuthContext'; // <-- use absolute path

const Header: React.FC = () => {
  const { theme, effectiveTheme, setTheme } = useTheme(); // CHANGED: 'toggleTheme' deleted
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800 transition-all duration-300">
        ...
        {/* Global click handler for menu close */}
