...
def get_users(
    ...
    """
    Getting a list of users (administrators only)).
    
    - **skip**: number of users to pass (for pagination)
...
def get_active_users(
    ...
    """
    Retrieving a list of active users (administrators only)).
    """
    user_service = UserService(db)
...
def get_user_statistics(
    ...
    """
    Obtaining user statistics (for administrators only).
...
def get_user(
    ...
    - A regular user can only view their profile
    """
...
def update_user(
    ...
    - A regular user can only update their profile
    - Only administrator can change roles and activity status
    """
    user_service = UserService(db)
...
def activate_user(
    ...
    """
    User activation (administrators only)).
    """
    user_service = UserService(db)
...
def deactivate_user(
    ...
    """
    Deactivate a user (administrators only).
...
def change_user_password(
    ...
    """
    Changing the user password by the administrator (administrators only).
...
def get_user_by_username(
    ...
    """
    Search for a user by username (administrators only)).
    """
    user_service = UserService(db)
...
def get_user_by_email(
    ...
    """
    Search user by email (only for administrators).
    """
    user_service = UserService(db)
