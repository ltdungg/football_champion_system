...
class MatchService:
    ...
    def _generate_tickets_for_match(self, match: Match) -> None:
        ...
        for category in categories:
            # We use the correct method name and pass the necessary objects
            price_info = self.ticket_calculator.calculate_ticket_price(
            ...
            tickets_data.append({
                "category": category,
                "price": price_info['final_price']  # We take the final price from the dictionary
            })
