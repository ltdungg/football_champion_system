...
from app.routers import teams, players, stadiums, matches, tickets, auth, reports, users, chat, audit
...
app.include_router(audit.router, prefix=f"{api_prefix}/audit-logs", tags=["audit"])
